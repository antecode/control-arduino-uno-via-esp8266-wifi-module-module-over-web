...
#define DEBUG true
#define DEBUG true
#define led_pin 4 //LED is connected to Pin 4 of Arduino
#define pump_pin 5 //LED is connected to Pin 5 of Arduino
#define alarm_pin 6 //LED is connected to Pin 6 of Arduino
...
//Lights loop
              if ((command1 == "led") && (command2 == "ON"))
                   ...
                   else if ((command1 == "led") && (command2 == "OFF")) 
                     {
                       digitalWrite(led_pin, LOW);
                     }
//Pump loop
                    if ((command1 == "pump") && (command2 == "ON"))
                    {
                      digitalWrite(pump_pin, HIGH);
                    }
                   else if ((command1 == "pump") && (command2 == "OFF")) 
                     {
                       digitalWrite(pump_pin, LOW);
                     }
//Alarm loop
                   if ((command1 == "alarm") && (command2 == "ON"))
                    {
                      digitalWrite(alarm_pin, HIGH);
                    }
                   else if ((command1 == "alarm") && (command2 == "OFF")) 
                     {
                       digitalWrite(alarm_pin, LOW);
                     }      
          }
